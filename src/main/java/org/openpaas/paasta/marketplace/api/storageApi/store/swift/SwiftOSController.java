package org.openpaas.paasta.marketplace.api.storageApi.store.swift;

import org.javaswift.joss.model.StoredObject;
import org.openpaas.paasta.marketplace.api.storageApi.config.SwiftOSConstants;
import org.openpaas.paasta.marketplace.api.storageApi.util.ObjectMapperUtils;
...
public class SwiftOSController {
    ...
    @GetMapping( SwiftOSConstants.SwiftOSControllerURI.OBJECT_STORAGE_HELLO_SERVICE )
    ...
    @PostMapping( value = { SwiftOSConstants.SwiftOSControllerURI.OBJECT_INSERT_URIS_A, SwiftOSConstants.SwiftOSControllerURI.OBJECT_INSERT_URIS_B } )
     ...
     */
    @CrossOrigin
    @GetMapping( SwiftOSConstants.SwiftOSControllerURI.OBJECT_GET_RAW_URI )
    public Object getObjectRawURL(
        @PathVariable( SwiftOSConstants.SwiftOSCommonParameter.OBJECT_FILENAME_PATH_VARIABLE ) String name ) throws FileNotFoundException {
     ...
     */
    @CrossOrigin
    @GetMapping( SwiftOSConstants.SwiftOSControllerURI.OBJECT_GET_CONTENT_TYPE_URI )
    ...
    @CrossOrigin
    @GetMapping( SwiftOSConstants.SwiftOSControllerURI.OBJECT_GET_RESOURCE_URI )
    public Object getObjectDownload(
            @PathVariable( SwiftOSConstants.SwiftOSCommonParameter.OBJECT_FILENAME_PATH_VARIABLE ) String name, final HttpServletResponse response )
            throws IOException {
     ...
     */
    @CrossOrigin
    @PutMapping( SwiftOSConstants.SwiftOSControllerURI.OBJECT_MODIFY_URI )
    ...
    @CrossOrigin
    @GetMapping( SwiftOSConstants.SwiftOSControllerURI.OBJECT_LIST_URI )
