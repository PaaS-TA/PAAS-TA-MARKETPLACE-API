...
import org.openpaas.paasta.marketplace.api.storageApi.util.BeanUtils;
...
public class SwiftOSConfig extends ObjectStorageConfig {
     ...
     * @return {@link AccountConfig AccountConfig}
     *
     */
    @Bean
    public AccountConfig accountConfig(){
        final String tenantName = env.getRequiredProperty(SwiftOSConstants.SwiftOSEnvironmentKeys.OBJECT_STORAGE_TENANT_NAME);
        final String username = env.getRequiredProperty(SwiftOSConstants.SwiftOSEnvironmentKeys.OBJECT_STORAGE_USER_NAME);
        final String password = env.getRequiredProperty(SwiftOSConstants.SwiftOSEnvironmentKeys.OBJECT_STORAGE_PASSWORD);
        final String authUrl = env.getRequiredProperty(SwiftOSConstants.SwiftOSEnvironmentKeys.OBJECT_STORAGE_AUTH_URL);
        final String authMethod = env.getRequiredProperty( SwiftOSConstants.SwiftOSEnvironmentKeys.OBJECT_STORAGE_AUTH_METHOD );
     ...
     * @param accountConfig
     * @return {@link AccountFactory AccountFactory}
     */
    @Bean
    ...
    public Container container(Account account){
        final String containerName = env.getRequiredProperty(SwiftOSConstants.SwiftOSEnvironmentKeys.OBJECT_STORAGE_CONTAINER);
